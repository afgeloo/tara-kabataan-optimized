...
const PinnedBlogsSection = memo(function PinnedBlogsSection({
  ...
  return _jsxs(_Fragment, {
    children: [
      _jsx("div", {
        className: "blogs-page-pinned-header",
        children: _jsx("h2", {
          children: pinnedBlogs.length === 1 ? "Pinned Blog" : "Pinned Blogs",
        }),
      }),
      _jsxs("div", {
        className: "blogs-page-pinned-blogs",
        children: [
          pinnedBlogs.length === 1 &&
            _jsx("div", {
              className: "blogs-page-pinned-container blogs-page-pinned-single",
              children: _jsx("div", {
                className: "blogs-page-pinned-full",
                style: {
                  "--bg-image": `url(${getSafeImageUrl(pinnedBlogs[0].image_url)})`,
                },
                onClick: () => onOpen(pinnedBlogs[0].blog_id),
                children: _jsxs("div", {
                  className: "blogs-page-pinned-overlay",
                  children: [
                    _jsx("p", {
                      className: "blogs-page-pinned-category-1",
                      children: pinnedBlogs[0].category,
                    }),
                    _jsx("h3", {
                      className: "blogs-page-pinned-title-1",
                      children: pinnedBlogs[0].title,
                    }),
                    _jsxs("p", {
                      className: "blogs-page-pinned-meta-1",
                      children: [
                        _jsx("img", {
                          src: timeiconwhite,
          ...
          pinnedBlogs.length === 2 &&
            _jsx("div", {
              className: "blogs-page-pinned-container blogs-page-pinned-double",
              children: pinnedBlogs.map((blog) =>
                _jsx(
                  "div",
                  {
                    className: "blogs-page-pinned-half",
                    style: {
                      "--bg-image": `url(${getSafeImageUrl(blog.image_url)})`,
                    },
          ...
          pinnedBlogs.length >= 3 &&
            _jsxs("div", {
              className: "blogs-page-pinned-container",
              children: [
                _jsx("div", {
                ...
                _jsx("div", {
                  className: "blogs-page-pinned-side",
                  children: pinnedBlogs.slice(1, 3).map((blog) =>
                    _jsx(
                      "div",
                      {
                        ...
                        children: _jsxs("div", {
                          ...
                          children: [
                            _jsx("p", {
                              className: "blogs-page-pinned-category-2",
                              children: blog.category,
                            }),
                            _jsx("h3", {
                              className: "blogs-page-pinned-title-2",
                              children: blog.title,
                            }),
                            _jsxs("p", {
                              className: "blogs-page-pinned-meta-2",
                              children: [
                                _jsx("img", {
                                  src: timeiconwhite,
                                  className: "blogs-page-timeiconwhite",
...
const BlogGrid = memo(function BlogGrid({ blogs, onOpen }) {
  if (!blogs.length) {
    return _jsx("div", {
      ...
      children: _jsx("p", { children: "No blogs found." }),
    });
  }
  return _jsx("div", {
    className: "blogs-page-blogs-grid",
    children: blogs.map((blog) =>
      _jsxs(
        "div",
        {
          className: "blogs-page-blog-item",
          children: [
            _jsx("img", {
            ...
            _jsxs("div", {
              ...
              children: [
                _jsx("p", {
                  className: "blogs-page-pinned-category-3",
                  children: blog.category,
                }),
                _jsx("h3", {
                ...
                _jsxs("p", {
                  className: "blogs-page-pinned-meta-3",
                  children: [
                    _jsx("img", {
                      src: timeblack,
                      className: "blogs-page-time-black",
                    }),
                    blog._dateText,
                    _jsx("img", {
                      src: authorblack,
...
export default function BlogsPage() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    fetch(
      `${API_BASE}/tara-kabataan-optimized/tara-kabataan-backend/api/blogs.php?category=ALL`,
      {
        signal: ctrl.signal,
      ...
      .then((data) => {
        ...
        setPinnedBlogs((prev) =>
          shallowEqualById(prev, pinned) ? prev : pinned
        );
  ...
  const pinnedSet = useMemo(
    () => new Set(pinnedBlogs.map((b) => b.blog_id)),
    [pinnedBlogs]
  );
  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      pinnedBlogs.length > 0 &&
        _jsx(PinnedBlogsSection, {
          pinnedBlogs: pinnedBlogs,
          onOpen: goToBlog,
        }),
      _jsxs("div", {
        className: "blogs-page-blog-categories",
        children: [
          _jsx("h2", {
          ...
          _jsxs("div", {
            className: "blogs-category-dropdown-search-bar",
            children: [
              _jsx("div", {
                className:
                  "blogs-category-buttons-desktop blogs-page-category-list",
              ...
              _jsx("div", {
                className: "blogs-category-dropdown-mobile",
              ...
              _jsxs("div", {
                className: "blog-searchbar-container",
                children: [
                  _jsx("input", {
                    type: "text",
      ...
      _jsx("hr", { className: "blogs-page-Hr" }),
      _jsx("div", {
        className: "blogs-page-blogs-list",
        children:
          loading || restoringScroll
            ? _jsx(Preloader, {})
            : _jsx(BlogGrid, { blogs: displayedBlogs, onOpen: goToBlog }),
      }),
      filteredBlogs.length > 4 &&
        _jsx("button", {
          ...
          disabled: isPending,
          children: showAllBlogs ? "Show Less" : "See More",
        }),
      _jsx(Footer, {}),
    ],
  });
...
function shallowEqualById(a, b) {
  ...
  for (let i = 0; i < a.length; i++)
    if (a[i].blog_id !== b[i].blog_id) return false;
  return true;
}
