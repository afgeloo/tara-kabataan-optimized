...
export default function SingleBlog() {
  ...
  if (notFound)
    return _jsx("div", {
      className: "single-blog-not-found",
      children: "Blog does not exist.",
    });
    ...
    children: [
      ...
      _jsxs("main", {
        ...
        children: [
          ...
          _jsx("div", {
            className: "single-blog-image-wrapper",
            children: _jsx("img", {
              src: heroUrl,
              alt: blog.title,
          ...
          moreImages.length > 0 &&
            _jsx("div", {
              className: "blog-more-image-grid",
          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsxs("div", {
                className: "single-blog-meta",
                children: [
                  _jsxs("div", {
                    className: "single-blog-meta-item",
                    children: [
                      _jsx("span", {
                      ...
                      _jsx("span", { children: formattedDate }),
                    ],
                  }),
                  _jsxs("div", {
                    className: "single-blog-meta-item",
                    children: [
                      ...
                      _jsx("span", { children: blog.author }),
                    ],
                  }),
                  _jsxs("button", {
                    className: "single-blog-copy-link",
                    onClick: copyBlogLink,
                    children: [
                      _jsx("img", { src: attachIcon, alt: "Copy" }),
                      _jsx("span", { children: "Copy Blog Link" }),
                    ],
                  }),
                ],
              }),
          ...
          showAllImagesModal &&
            _jsxs("div", {
              ...
              children: [
                ...
                _jsxs("div", {
                  className: "blog-gallery-wrapper",
                  children: [
                    _jsx("button", {
                    ...
                    _jsx("div", {
                      className: "blog-gallery-grid",
                      children: moreImages.map((img, idx) =>
                        _jsx(
                          "div",
                          {
                            className: "blog-gallery-thumb",
                            children: _jsx("img", {
                              src: img,
                              alt: `Gallery ${idx}`,
                              loading: "lazy",
          ...
          fullImageUrl &&
            _jsxs("div", {
              className: "blog-fullscreen-viewer",
              children: [
                _jsx("div", {
