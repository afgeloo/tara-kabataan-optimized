...
const AboutAdvocacies = memo(function AboutAdvocacies() {
  ...
  return _jsxs("section", {
    className: "advocacies-section",
    "aria-labelledby": "advocacies-header",
    children: [
      _jsx("hr", { className: "advocacies-line" }),
      _jsx("h1", {
        id: "advocacies-header",
        className: "advocacies-header",
        children: "Advocacies",
      }),
      _jsx("div", {
        className: "advocacies-slider",
        role: "list",
        children: slides.map((slide) => {
          ...
          return _jsxs(
            "article",
            {
              ...
              children: [
                _jsxs("div", {
                  className: "advocacy-icon-container",
                  "aria-hidden": "true",
                  children: [
                    _jsx("img", {
                ...
                _jsx("h2", {
                  className: "advocacy-category",
                  children: slide.category,
                }),
                _jsx("p", {
                  className: "advocacy-title",
                  children: slide.title,
                }),
                leads.length > 0 &&
                  _jsx("h3", {
                    className: "advocacy-category",
                    children: leads.length > 1 ? "Leads" : "Lead",
                  }),
                _jsx("div", {
                  className: "advocacy-leads",
                    ...
                    _jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          _jsx("p", {
                            className: "advocacy-lead",
                            children: lead.member_name,
                          }),
                        ],
                      },
                      lead.member_id
