...
const BriefBg = memo(() => {
  ...
  return _jsxs("div", {
    className: "briefbg-sec",
    children: [
      _jsx("div", {
        className: "briefbg-carousel-bg",
        children: _jsx("img", {
          src: ribbon,
      ...
      _jsxs("div", {
        className: "briefbg-sec-content",
        children: [
          _jsx("h1", {
            className: "briefbg-header",
            children: "Brief Background",
          }),
          _jsx("p", { className: "briefbg-description", children: background }),
        ],
      }),
      _jsx("hr", { className: "briefbg-line" }),
    ],
  });
});
