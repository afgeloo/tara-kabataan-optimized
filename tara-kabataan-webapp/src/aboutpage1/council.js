...
export default function Council() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      fetch(aboutUrl, { signal: ctrl.signal }).then((r) =>
        r.ok ? r.json() : Promise.reject(r)
      ),
      fetch(councilUrl, { signal: ctrl.signal }).then((r) =>
        r.ok ? r.json() : Promise.reject(r)
      ),
    ])
      .then(([about, council]) => {
        ...
        const blacklist = new Set(
          BLACKLISTED_ROLES.map((s) => s.toLowerCase())
        );
  ...
  const { president, others } = useMemo(() => {
    const prez = councilData.find(
      (m) => m.role_name.toLowerCase() === "president"
    );
    const rest = councilData.filter((m) => m !== prez);
    return { president: prez, others: rest };
  }, [councilData]);
  return _jsxs("div", {
    className: "council-sec",
    children: [
      _jsx("div", {
        className: "council-ribbon",
        children: _jsx("img", {
          src: ribbon,
          alt: "ribbon",
          loading: "lazy",
      ...
      _jsxs("div", {
        className: "council-sec-content",
        children: [
          _jsx("h1", { className: "council-header", children: "Council" }),
          _jsx("p", {
      ...
      president &&
        _jsx("div", {
          className: "council-president-grid",
          children: _jsx("div", {
            className: "council-card council-card-main",
            children: _jsx("div", {
              className: "council-inner-card-1-president",
              children: _jsxs("div", {
                className: "council-inner-card-2",
                children: [
                  _jsx("div", {
                    className: "council-member-image",
                    children: _jsx("img", {
                      src: president.member_image,
                  ...
                  _jsx("h1", {
                    className: "council-member-name",
                    children: president.member_name,
                  }),
                  _jsx("p", {
                    className: "council-member-role",
                    children: president.role_name,
                  }),
                ],
              }),
            }),
        ...
        children: others.map((member) =>
          _jsx(
            "div",
            {
              ...
              children: _jsx("div", {
                className: "council-inner-card-1-members",
                children: _jsxs("div", {
                  className: "council-inner-card-2",
                  children: [
                    _jsx("div", {
