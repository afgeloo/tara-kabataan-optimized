...
const PartnerSec = memo(() => {
  ...
  if (displayedLogos.length === 0) {
    ...
    return _jsxs("div", {
      ...
      children: [
        _jsx("h1", {
          className: "PastPartnership-Text",
          children: "PAST PARTNERSHIPS",
        }),
        _jsx("hr", { className: "Hr-under-pastpartnership" }),
        _jsxs("div", {
          className: "partner-member-container",
          children: [
            _jsxs("div", {
              className: "BePartnerMemberSection",
              children: [
                _jsx("h2", {
                  className: "BePartnerMemberText",
                  children: "BE A PARTNER",
                }),
                _jsxs("div", {
                  className: "BePartnerMemberSection-box",
                  children: [
                    _jsx("div", {
                      className: "circle-inside-be-a-partner-member",
                      children: _jsx("img", {
                        src: partnerLogo,
                        alt: "Partner Logo",
                        className: "circle-image partner-image",
                      }),
                    }),
                    _jsx("p", {
                      className: "text-inside-be-a-partner-member-container",
                      children:
                    ...
                    _jsx(Link, {
                      to: "/Contact",
                      className: "button-inside-be-a-partner-member",
                  ...
                  children: [
                    _jsx("div", {
                      ...
                      children: _jsx("img", {
                        src: memberLogo,
                        alt: "Member Logo",
                        className: "circle-image member-image",
                      }),
                    }),
                    _jsx("p", {
                      className: "text-inside-be-a-partner-member-container",
        ...
        _jsx("h2", {
          className: "support-tk-title",
          children: "SUPPORT TARA KABATAAN",
        }),
        _jsxs("div", {
          className: "support-tk-container",
          children: [
            _jsxs("div", {
              className: "support-tk-content-format",
              children: [
                _jsx("div", {
                  className: "logo-inside-donate-now-placing",
                  children: _jsx("img", {
                    src: tklogo,
                    className: "logo-inside-donate-now-sizing",
                    alt: "Support Logo",
                  }),
                }),
                _jsx("div", {
                  className: "support-tk-text",
                  children: _jsx("p", {
                    children:
                      "Your donation is more than just a contribution \u2014 it\u2019s a commitment to youth empowerment and inclusive nation-building. Every peso you give fuels Tara Kabataan\u2019s programs that uplift communities, advance human rights, and promote genuine civic engagement. Whether it\u2019s through in-kind support or financial assistance, your help goes directly to grassroots initiatives: from relief operations and educational drives to health missions and climate justice actions.",
                  }),
                }),
              ],
            }),
            _jsxs("button", {
              className: "donate-now-section",
              onClick: () => setShowQR(true),
              children: [
                _jsx("img", {
                  src: donateicon,
                  alt: "Donate Icon",
                  className: "logo-inside-donate-now",
                }),
                _jsx("span", {
                  className: "donate-now-text",
                  children: "DONATE NOW",
                }),
              ],
            }),
          ...
          _jsx("div", {
            ...
            children: _jsxs("div", {
              ...
              children: [
                ...
                _jsx("p", {
                  children:
                    "Open GCash, Maya, or any app with a built-in QR scanner to scan:",
                }),
                _jsx("img", {
                  src: tkdonate,
                  alt: "QR Code",
                ...
                _jsx("p", { children: "Or message us directly on Messenger:" }),
                _jsx("a", {
      ...
      _jsx("div", {
        children: _jsx(
          Marquee,
          {
            ...
            children: displayedLogos.map((logo, index) =>
              _jsx(
                "div",
                {
          ...
          `partner-marquee-${displayedLogos.length}`
        ),
      }),
      _jsx("hr", { className: "Hr-under-pastpartnership" }),
      _jsxs("div", {
