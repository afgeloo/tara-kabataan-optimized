...
function WelcomeSec() {
    ...
    return (_jsxs("div", { className: "welcome-sec", children: [_jsx("div", { className: "wave-container", children: _jsx(Wave, {}) }), _jsx("div", { className: "flower-container top-layer", children: _jsx(Marquee, { gradient: false, speed: 50, loop: 0, play: !prefersReducedMotion, children: _jsxs("div", { className: "flowers1", children: [flowers.map((_, i) => (_jsx("img", { src: "./src/assets/homepage/flowers.png", alt: "Flower", loading: "lazy", decoding: "async", draggable: false }, `f1-${i}`))), _jsx("div", { style: spacer })] }) }) }), _jsx("div", { className: "flower-container bottom-layer", children: _jsx(Marquee, { gradient: false, speed: 90, loop: 0, direction: "left", play: !prefersReducedMotion, children: _jsxs("div", { className: "flowers2", children: [flowers.map((_, i) => (_jsx("img", { src: "./src/assets/homepage/flowers.png", alt: "Flower", loading: "lazy", decoding: "async", draggable: false }, `f2-${i}`))), _jsx("div", { style: spacer })] }) }) }), _jsx("div", { className: "welcome1", children: _jsx("img", { src: "./src/assets/homepage/welcome.png", alt: "Welcome", decoding: "async", draggable: false }) }), _jsxs("div", { className: "cow", children: [_jsx("div", { className: "cow-shadow" }), _jsx("img", { src: "./src/assets/homepage/tk-cow-walking.gif", alt: "Cow", decoding: "async", draggable: false })] }), _jsx("div", { className: "welcome3", children: _jsx("img", { src: "./src/assets/homepage/welcome1.png", alt: "Welcome 1", decoding: "async", draggable: false }) }), _jsxs("div", { className: "clouds-content-container", children: [_jsx("img", { src: "./src/assets/homepage/top-cloud.png", className: "top-cloud", alt: "Top Cloud", loading: "lazy", decoding: "async", draggable: false }), _jsx("div", { className: "content-section-main", children: _jsxs("div", { className: "content-grid", children: [_jsx("div", { className: "empty" }), _jsxs("div", { className: "whatsTK", children: [_jsx("h2", { children: "What is TARA KABATAAN?" }), _jsx("p", { children: overview })] }), _jsx("div", { className: "tk-logo", children: _jsx("img", { src: "./src/assets/homepage/tk-logo-label.png", alt: "Tara Kabataan", loading: "lazy", decoding: "async", draggable: false }) }), _jsx("div", { className: "know-more", children: _jsxs(Link, { to: "/About", className: "nav-know-more", children: [_jsx("img", { src: "./src/assets/homepage/bulb.png", alt: "Know More", loading: "lazy", decoding: "async", draggable: false }), "KNOW MORE"] }) }), _jsx("div", { className: "empty" }), _jsx("div", { className: "empty" })] }) }), _jsx("img", { src: "./src/assets/homepage/bot-cloud.png", className: "bot-cloud", alt: "Bottom Cloud", loading: "lazy", decoding: "async", draggable: false })] })] }));
}
