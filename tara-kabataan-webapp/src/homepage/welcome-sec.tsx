...
const Wave: React.FC = memo(() => (
  <div className="wave-container">
    <svg width="100%" height="auto" version="1.1" xmlns="http://www.w3.org/2000/svg" style={{ fillRule: "evenodd", clipRule: "evenodd", strokeLinecap: "round", strokeLinejoin: "round" }}>
      <path d="M50,39 C200,10 400,70 600,39 C800,10 1000,70 1200,39 C1400,10 1600,70 1800,39" style={{ fill: "none", stroke: "#F875AA", strokeOpacity: 0.5, strokeWidth: 2, strokeDasharray: "280 550 160 600 260 350" }}>
        <animate attributeName="stroke-dashoffset" from="-2200" to="0" dur="32s" repeatCount="indefinite" />
      </path>
    </svg>
    <svg width="100%" height="auto" version="1.1" xmlns="http://www.w3.org/2000/svg" style={{ fillRule: "evenodd", clipRule: "evenodd", strokeLinecap: "round", strokeLinejoin: "round" }}>
      <path d="M50,39 C200,10 400,70 600,39 C800,10 1000,70 1200,39 C1400,10 1600,70 1800,39" style={{ fill: "none", stroke: "#0F82CA", strokeOpacity: 0.5, strokeWidth: 2, strokeDasharray: "180 250 160 700 260 650" }} strokeDashoffset="180">
      ...
      <div className="flower-container top-layer">
        <Marquee gradient={false} speed={50} loop={0} play={!prefersReducedMotion}>
          <div className="flowers1">
            {flowers.map((_, i) => (<img key={`f1-${i}`} src={flowersImg} alt="Flower" loading="lazy" decoding="async" draggable={false} />))}
            <div style={spacer} />
          </div>
        </Marquee>
      </div>
      <div className="flower-container bottom-layer">
        <Marquee gradient={false} speed={90} loop={0} direction="left" play={!prefersReducedMotion}>
          <div className="flowers2">
            {flowers.map((_, i) => (<img key={`f2-${i}`} src={flowersImg} alt="Flower" loading="lazy" decoding="async" draggable={false} />))}
            <div style={spacer} />
          </div>
        </Marquee>
      </div>
      <div className="welcome1"><img src={welcomeImg} alt="Welcome" decoding="async" draggable={false} /></div>
      <div className="cow">
        <div className="cow-shadow" />
        <img src={cowGifImg} alt="Cow" decoding="async" draggable={false} />
      </div>
      <div className="welcome3"><img src={welcome1Img} alt="Welcome 1" decoding="async" draggable={false} /></div>
      <div className="clouds-content-container">
        <img src={topCloudImg} className="top-cloud" alt="Top Cloud" loading="lazy" decoding="async" draggable={false} />
        <div className="content-section-main">
          <div className="content-grid">
            ...
            <div className="tk-logo">
              <img src={logoLabelImg} alt="Tara Kabataan" loading="lazy" decoding="async" draggable={false} />
            </div>
            <div className="know-more">
              <Link to="/About" className="nav-know-more">
                <img src={bulbImg} alt="Know More" loading="lazy" decoding="async" draggable={false} />
                KNOW MORE
              </Link>
            </div>
            <div className="empty" />
        ...
        <img src={botCloudImg} className="bot-cloud" alt="Bottom Cloud" loading="lazy" decoding="async" draggable={false} />
      </div>
    </div>
  );
}
