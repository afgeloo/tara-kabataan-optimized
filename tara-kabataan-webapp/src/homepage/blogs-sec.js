...
const BlogCard = memo(({ blog }) => {
  ...
  return _jsxs(Link, {
    ...
    children: [
      _jsx("div", {
        className: "blogs-image-container",
        children:
          imgOk && imgSrc
            ? _jsx("img", {
                src: imgSrc,
      ...
      _jsx("div", {
        ...
        children: _jsx("h1", { children: title }),
      }),
      _jsx("div", {
        className: "blog-category",
        children: _jsx("p", { children: category }),
      }),
      _jsx("div", { className: "blog-description", children: preview }),
    ],
  });
});
...
const BlogCardSkeleton = () =>
  _jsxs("div", {
    className: "blog-box skeleton",
    children: [
      _jsx("div", { className: "blogs-image-container skeleton-block" }),
      _jsx("div", { className: "blog-title skeleton-line" }),
      _jsx("div", { className: "blog-category skeleton-line" }),
      _jsx("div", { className: "blog-description skeleton-lines" }),
    ],
  });
// -- Main --------------------------------------------------------------------
const BlogsSec = () => {
      ...
      children: _jsxs("div", {
        ...
        children: [
          ...
          _jsxs("div", {
            ...
            children: [
              _jsxs("div", {
                className: "blogs-container-sec",
                children: [
                  _jsx("h1", { className: "blogs-header", children: "BLOGS" }),
                  _jsxs("div", {
          ...
          children: [
              ...
              children: [
                ...
                _jsx("div", {
                  ...
                  children: blogs.map((b) =>
                    _jsx(BlogCard, { blog: b }, b.blog_id)
                  ),
                }),
              ],
            }),
            _jsx("div", {
              ...
              children: _jsxs(Link, {
                ...
                className: "nav-blogs",
                children: [
                  _jsx("img", { src: BookIcon, alt: "Read More Icon" }),
                  "READ MORE",
                ],
              }),
            }),
