...
const EventsSec = memo(() => {
  ...
  return _jsx("div", {
    ...
    children: _jsx("div", {
      className: "events-sec-content",
      children: _jsxs("div", {
        className: "carousel-container",
        children: [
          _jsx("h1", { className: "events-header", children: "EVENTS" }),
          slides.length > 0 &&
            _jsx(EventsCarousel, {
              slides: slides,
              autoSlide: true,
          ...
          _jsx("div", {
            className: "events-sec-nav",
            children: _jsxs(Link, {
              to: "/Events",
              className: "nav-events",
              children: [
                _jsx("img", { src: calendarImg, alt: "Calendar Icon" }),
                "SEE MORE",
              ],
            }),
          }),
