...
const GoToTop = () => {
    ...
    return (_jsx("div", { className: `go-to-top ${isVisible ? "show" : ""}`, onClick: scrollToTop, onKeyDown: (e) => e.key === "Enter" && scrollToTop(), role: "button", "aria-label": "Go to top", "aria-hidden": !isVisible, tabIndex: 0, title: "Go to top", children: _jsx(IoIosArrowUp, { size: 24 }) }));
};
