...
function GetInTouch() {
    ...
    return (_jsxs("div", { className: "getintouch-sec", children: [_jsxs("div", { className: "getintouch-content", children: [_jsx("h1", { className: "getintouch-header", children: "Get in Touch" }), _jsx("p", { className: "getintouch-description", children: "Reach out to us through any of our contact points below. We're here to listen and connect with you!" })] }), _jsxs("div", { className: "getintouch-sub-sec", children: [_jsxs("div", { className: "getintouch-left", children: [_jsxs("div", { className: "contact-telephone", children: [_jsx("a", { href: `tel:${contactNo}`, target: "_blank", rel: "noopener noreferrer", children: _jsx("div", { className: "contact-telephone-icon", children: _jsx("img", { src: telephoneImg, alt: "Telephone Icon", draggable: "false" }) }) }), _jsxs("div", { className: "contact-telephone-details", children: [_jsx("h1", { className: "contact-telephone-header", children: "Telephone" }), _jsx("p", { className: "contact-telephone-no", children: contactNo })] })] }), _jsxs("div", { className: "contact-email", children: [_jsx("div", { onClick: () => navigate("/contact"), style: { cursor: "pointer" }, children: _jsx("div", { className: "contact-email-icon", children: _jsx("img", { src: emailImg, alt: "Email Icon", draggable: "false" }) }) }), _jsxs("div", { onClick: () => navigate("/contact"), style: { cursor: "pointer" }, className: "contact-email-details", children: [_jsx("h1", { className: "contact-email-header", children: "Email" }), _jsx("p", { className: "contact-email", children: email })] })] })] }), _jsxs("div", { className: "getintouch-right", children: [_jsxs("div", { className: "contact-telephone", children: [_jsx("a", { href: facebookLink, target: "_blank", rel: "noopener noreferrer", children: _jsx("div", { className: "contact-telephone-icon", children: _jsx("img", { src: facebookImg, alt: "Facebook Icon", draggable: "false" }) }) }), _jsxs("div", { className: "contact-telephone-details", children: [_jsx("h1", { className: "contact-telephone-header", children: "Facebook" }), _jsx("p", { className: "contact-telephone-no", children: "Tara Kabataan" })] })] }), _jsxs("div", { className: "contact-email", children: [_jsx("a", { href: instagramLink, target: "_blank", rel: "noopener noreferrer", children: _jsx("div", { className: "contact-email-icon", children: _jsx("img", { src: instagramImg, alt: "Instagram Icon", draggable: "false" }) }) }), _jsxs("div", { className: "contact-email-details", children: [_jsx("h1", { className: "contact-email-header", children: "Instagram" }), _jsx("p", { className: "contact-email", children: "@tarakabataan" })] })] })] })] })] }));
}
