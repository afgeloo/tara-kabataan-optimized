...
function EventsPageRSVP() {
  ...
  const [viewType, setViewType] = useState(
    () => sessionStorage.getItem("eventViewType") || "UPCOMING"
  );
  ...
  useEffect(() => {
    ...
    setLoading(true);
    fetch(
      `${API_BASE}/tara-kabataan-optimized/tara-kabataan-backend/api/events.php`,
      {
        signal: ctrl.signal,
  ...
  const filteredEvents = useMemo(() => {
    ...
    return events.filter((event) => {
      ...
      const [sh, sm] = (event.event_start_time || "00:00")
        .split(":")
        .map(Number);
          ...
          setEvents((prev) =>
            prev.map((evt) =>
              evt.event_id === selectedEventId
                ? { ...evt, event_going: (evt.event_going || 0) + 1 }
                : evt
            )
          );
          setShowModal(false);
      ...
      loading || restoringScroll
        ...
        : _jsxs(_Fragment, {
            children: [
              ...
              _jsx("hr", { className: "events-header-divider" }),
              _jsx("h1", {
                className: "eventspage-header-2-EVENTS",
                children: "Events",
              }),
              _jsxs("div", {
                className: "events-header-row-2",
                children: [
                  _jsxs("div", {
                    className: "event-searchbar-container",
                    children: [
                      _jsx("input", {
                        type: "text",
              ...
              _jsxs("div", {
                className: "event-category-search-wrapper",
                children: [
                  _jsxs("div", {
                  ...
                  _jsxs("div", {
                    className: "event-filter-wrapper",
                    children: [
                      _jsxs("select", {
              ...
              _jsx("div", { className: "custom-divider-pagination" }),
              filteredEvents.length > 0
                ? _jsxs("div", {
                    className: "eventsrsvp-grid",
                    children: [
                ...
                : _jsx("div", {
                    ...
                    children: _jsx("p", { children: "No events found." }),
                  }),
            ],
          }),
      showModal &&
        _jsx("div", {
          className: "event-rsvp-modal-overlay",
          onClick: closeModal,
          children: _jsxs("div", {
            ...
            children: [
              ...
              _jsxs("form", {
                ...
                children: [
                  ...
                  _jsxs("div", {
                    className: "event-rsvp-form-actions",
                    children: [
                      _jsx("button", {
                        type: "button",
                        onClick: closeModal,
                        className:
                          "event-rsvp-form-btn event-rsvp-form-btn-cancel",
                        children: "Cancel",
                      }),
                      _jsx("button", {
                        type: "submit",
                        disabled: submitting,
                        className:
                          "event-rsvp-form-btn event-rsvp-form-btn-submit",
