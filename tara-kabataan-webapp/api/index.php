 ...
 * so every deployment failed before it built. vercel.json now declares only
 * this file as a function and rewrites /api/<script>.php to it; each endpoint
 * keeps its own file and is dispatched here, collapsing 61 functions into 1.
 *
 * The endpoint name arrives as __endpoint from the rewrite. REQUEST_URI is a
 * fallback so this file also works when hit directly.
 */
